...
- **Build**: `dotnet build src/GitDiffToJsonLCli/GitDiffToJsonLCli.csproj`
- **Run**: `dotnet run --project src/GitDiffToJsonLCli/GitDiffToJsonLCli.csproj -- [args]`
...
## Structure
- `src/GitDiffToJsonLCli/`: Main application logic.
- `src/GitDiffToJsonLCli/Contexts/`: JSON serialization contexts.
- `src/GitDiffToJsonLApp.slnx`: Modern .NET solution file.
